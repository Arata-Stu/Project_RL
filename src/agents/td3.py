...
class TD3Agent(BaseAgent):
    def __init__(self, 
        ...
        """
        super().__init__(state_dim, action_dim, gamma, tau, actor_lr, critic_lr)
        
        self.actor = ActorTD3(state_dim, action_dim, hidden_dim).to(self.device)
        self.actor_target = ActorTD3(state_dim, action_dim, hidden_dim).to(self.device)
